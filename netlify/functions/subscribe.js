  ...
  <div style="background:white;border:1px solid #e5e7eb;border-top:none;padding:28px 26px;border-radius:0 0 6px 6px;">
    ...
    <div style="background:#f8f6f2;border-left:3px solid #2c5f7c;padding:14px 18px;border-radius:0 4px 4px 0;margin-bottom:24px;">
      ...
      <div style="font-size:13px;color:#374151;line-height:2;font-family:monospace;">
        <span style="color:#cc0000;">●</span> Flood Stage &nbsp;858.0+ ft — At or above flood stage<br>
        <span style="color:#8b1a00;">●</span> Critical &nbsp;&nbsp; 857.0–858.0 ft — Approaching flood stage<br>
        <span style="color:#c44400;">●</span> High &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 856.5–857.0 ft — Road impacts possible<br>
        <span style="color:#c47000;">●</span> Elevated &nbsp;&nbsp; 855.5–856.5 ft — Low-lying flooding possible<br>
        ...
        <span style="color:#1a6b3a;">●</span> Normal &nbsp;&nbsp;&nbsp;&nbsp; Below 854.0 ft — No action needed
      </div>
    </div>
